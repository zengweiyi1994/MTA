...
try
{
    ...
    else #They've passed all the roadblocks - let them write something
    {
        ...
        $content .= "<form id='submission' action='".get_redirect_url("submitsubmission.php?assignmentid=$assignment->assignmentID&$authorInGet$closeOnDone")."' method='post' accept-charset='UTF-8' $attribs >\n";
