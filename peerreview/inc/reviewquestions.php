        ...
        function getScore(ReviewAnswer $answer = null)
        {
            if($answer)
            {
                if($answer->int < sizeof($this->options) && $answer->int >= 0)
                    ...
                    throw new Exception("An invalid was detected with index $answer->int while retrieving score");
            }
        ...
        function _getAnswerHTML(ReviewAnswer $answer = null)
        {
            if($answer)
            {
                ...
                if($answer->int < sizeof($this->options) && $answer->int >= 0)
                    ...
                    throw new Exception("An invalid answer was detected with index $answer->int while retrieving text");
            }
            return "(No Answer)";
        }
