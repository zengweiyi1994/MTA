	...
	*/
    ...
    function getPoolStatusHTML(UserID $user)
    {
      ...
      if($isIndependent) {
        ...
        return "<b>Supervised</b> reviewer<br>";
      }
    }
    ...
    function _getHeaderHTML(UserID $user)
    {
        ...
        if($dataMgr->isMarker($user))
        {
            ...
            $html .= "</tr></table>\n";
            $html .= "<table width='100%'><tr><td>Appeals Due: <span id='appealStopDate$this->assignmentID'></span></td></tr>";
