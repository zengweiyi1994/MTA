...
try
{
    ...
    else
    {
        ...
        #$dataMgr->numStudents();
		$content .= "<h1>Weekly Schedule</h1>\n";
		$content .= "<b>Assignments Posted:</b> 5pm previous Wednesday<br>";
		$content .= "<b>Assignments Due:</b> 3pm on class days<br>";
		$content .= "<b>Reviews Open:</b> 5pm on class days<br>";
		$content .= "<b>Reviews Due:</b> 1pm on Friday<br>";
        ...
        if($dataMgr->isInstructor($USERID))
        {
            ...
            $content .= "<table align='left' style='width:100%'>\n";
            $content .= "<tr><td><a title='Create new Assignment' href='".get_redirect_url("editassignment.php?action=new")."'><div class='icon new' style='float: left'></div>Create Assignment</a></td></tr>\n";
            $content .= "<tr><td><a title='Run Scripts' href='".get_redirect_url("runscript.php")."'><div class='icon script' style='float: left'></div>Run Script</a></td></tr>\n";
            $content .= "<tr><td><a title='User Manager' href='".get_redirect_url("usermanager.php")."'><div class='icon userManager' style='float: left'></div>User Manager</a></td></tr>\n";
